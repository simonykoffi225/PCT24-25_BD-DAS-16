<footer class="position-relative overflow-hidden pb-0 pt-6 pt-lg-8 text-white" style="background-color: #009345;" data-bs-theme="white">
	...
	<figure class="position-absolute top-0 start-0 mt-n8 ms-n9">
		<svg class="fill-mode" width="775px" height="834px" viewBox="0 0 775 834" style="enable-background:new 0 0 775 834; opacity: 0.05;" xml:space="preserve">
			...
			<path d="M573.5,509.5c-8.2,5.8-147.4,10.7-27.7,14.6c-59.3,22-119.1,18.8-176.8,15.8c-53.2-2.8-103.3-5.3-147.1,12.5 C172.6,572.3,138.1,615.5,113,688l-0.5-0.1c25.1-72.7,59.6-115.9,108.9-136c44-18,94.2-15.3,147.6-12.6 c57.7,3,117.4,6.1,176.6-15.9c70.7-26.2,91.1-106.3,112.8-191.4c13.9-54.5,28.3-111,56.7-156.9C747,123.2,793,92.6,855.6,82l0,0.7 C716.3,106.5,687,221.4,658.9,332.2C640.4,405,622.6,474.4,573.5,509.5z"></path>
			...
			<div class="col-lg-8 col-xxl-7">
				<div class="row g-4">
					...
					<div class="col-6 col-md-4">
						<h6 class="mb-2 mb-md-4" style="color:white">Etat Civil</h6>
						<ul class="nav flex-column">
							<li class="nav-item"><a class="nav-link pt-0" href="{{ route('apropos') }}">A propos de nous</a></li>
							<li class="nav-item"><a class="nav-link" href="{{ route('contact') }}">Contact</a></li>
							<!-- <li class="nav-item"><a class="nav-link" href="">Career <span class="badge text-bg-white ms-2">2 Job</span></a></li>
					...
					<!-- Link block -->
					<div class="col-6 col-md-4">
						<h6 class="mb-2 mb-md-4" style="color:white">liens utiles</h6>
						<ul class="nav flex-column">
							<li class="nav-item"><a class="nav-link pt-0" href="https://www.oneci.ci/accueil">ONECI</a></li>
							<li class="nav-item"><a class="nav-link" href="https://rnpp.ci/">RNPP </a></li>
							<li class="nav-item"><a class="nav-link" href="https://snedai.com/passeport-en-cote-divoire/">SNEDAI</a></li>
							<li class="nav-item"><a class="nav-link" href="https://interieur.gouv.ci/accueil">Ministère de l'intérieur</a></li>
