...
<div class="col-lg-8 col-xl-9 ps-lg-4 ps-xl-6">
    ...
    <div class="table-responsive border-0">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <form action="{{ route('actedeces.destroy', $acte->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet acte?')">
                                ...
                                <button type="button" class="btn btn-sm btn-danger delete-btn" 
                                        data-id="{{ $acte->id }}" 
                                        data-url="{{ route('actedeces.destroy', $acte->id) }}"
                                        title="Supprimer">
        ...
        <div class="d-flex justify-content-center mt-4">
            {{-- {{ $actesDeces->links() }} --}}
            {{ $actesDeces->appends(request()->query())->links('pagination::bootstrap-5') }}
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Êtes-vous sûr de vouloir supprimer cet acte de décès ? Cette action est irréversible.
                </div>
